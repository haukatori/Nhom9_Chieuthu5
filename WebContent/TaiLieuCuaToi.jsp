...
<sql:query dataSource="${snapshot}" var="Ref"
	sql=" Select TenTaiLieu,TrangThai,NgayTaiLen from thongtintailieu Where NguoiTaiLen='${sessionScope.user}'">;
         </sql:query>
     <    


<!DOCTYPE html PUBLIC "
	-//W3C//DTDXHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<body>
	...
	<footer class="py-5 bg-dark">
		<div class="container">
			<p class="m-0 text-center text-white">Copyright © 2017, Phạm
				Quang Trung - Trần Công Hậu</p>
		</div>
		<!-- /.container -->
	</footer>
</body>
